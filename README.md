...
[![My Skills](https://skillicons.dev/icons?i=html,css,js,bootstrap,tailwind,react,ts,django,fastapi,sqlite,mongodb,postgresql,firebase,md,git,github,vscode,pytest,styledcomponents,postman,stackoverflow&perline=13)](#)
